...
// Query status OPEN
$sql = "SELECT `template_version`,count(`action`)FROM sugarcrm_hr.email_tracking WHERE template_version='CLBS2016V1' && `action`='open'";
...
// Query status Unread
$sql = "SELECT `template_version`,count(`action`)FROM sugarcrm_hr.email_tracking WHERE template_version='CLBS2016V1' && `action`='unread'";
$result = $conn->query($sql);
...
$sql = "SELECT `template_version`,count(`action`)FROM sugarcrm_hr.email_tracking WHERE template_version='CLBS2016V1' && `action`='replied'";
$result = $conn->query($sql);
...
// Query status Click
$sql = "SELECT `template_version`,count(`action`)FROM sugarcrm_hr.email_tracking WHERE template_version='CLBS2016V1' && `action`='click'";
